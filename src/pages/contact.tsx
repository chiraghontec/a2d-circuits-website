              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                ...
                <div className="space-y-4 text-[var(--color-charcoal-gray)]">
                  <p className="flex items-center">
                    <span className="font-semibold text-[var(--color-black)] w-24">Phone:</span> 
                    (555) 123-4567
                  </p>
                  <p className="flex items-center">
                    <span className="font-semibold text-[var(--color-black)] w-24">Email:</span> 
                    support@a2dcircuits.com
                  </p>
                  <p className="flex items-start">
                    <span className="font-semibold text-[var(--color-black)] w-24">Address:</span> 
                    123 Circuit Lane, Techville, CA 91234
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-black)] text-sm">Technical Support</h3>
                      <p className="text-sm text-[var(--color-charcoal-gray)]">
                        Need help with component specifications? Our experts are here to assist.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-black)] text-sm">Order Support</h3>
                      <p className="text-sm text-[var(--color-charcoal-gray)]">
                        Questions about your order? We&apos;ll track it down and keep you updated.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-black)] text-sm">Component Search</h3>
                      <p className="text-sm text-[var(--color-charcoal-gray)]">
                        Can&apos;t find what you need? Let us source that hard-to-find component for you.
                      </p>
                    </div>
                  </div>
                </div>
